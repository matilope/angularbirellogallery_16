...
export const routes: Routes = [
  ...
  { path: 'miscellaneous', loadComponent: () => import('@modules/users/miscellaneous/pages/miscellaneous.component').then(m => m.MiscellaneousComponent), title: 'Miscellaneous', resolve: { token: TokenResolve } },
  { path: 'about', loadComponent: () => import('@modules/users/about/pages/about.component').then(m => m.AboutComponent), title: 'About' },
  { path: 'contact', loadComponent: () => import('@modules/users/contact/pages/contact.component').then(m => m.ContactComponent), title: 'Contact', resolve: { paintings: PaintingsResolve } },
  { path: 'painting/view/:id', loadComponent: () => import('@modules/users/painting/pages/painting.component').then(m => m.PaintingComponent), resolve: { painting: PaintingResolve } },
  ...
  // { path: 'admin/register', loadComponent:()=>import('@modules/users/register/pages/register.component').then(m => m.RegisterComponent), title: 'Register' },
  {
    path: 'admin', canActivate: [AuthGuard], children: [
      { path: '', pathMatch: 'full', loadComponent: () => import('@modules/admin/admin/pages/admin.component').then(m => m.AdminComponent), title: 'Administration Panel', resolve: { paintings: PaintingsResolve } },
      ...
      { path: 'update/:id', loadComponent: () => import('@modules/admin/painting-update/pages/painting-update.component').then(m => m.PaintingUpdateComponent), title: 'Update Painting', resolve: { painting: PaintingResolve } },
